...
gmsh.model.occ.addRectangle(0, 0, 0, 0.41, 2.5, 1)
...
solid_boundary = gmsh.model.addPhysicalGroup(1, [5], 4)
...
solid = gmsh.model.addPhysicalGroup(2, [2], 2)
gmsh.model.setPhysicalName(2, solid, "solid")
domain = gmsh.model.addPhysicalGroup(2, [2,3], 3)
...
gmsh.write("rectangle_circle.msh")
gmsh.finalize() 
